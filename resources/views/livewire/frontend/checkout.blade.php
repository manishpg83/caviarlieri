        ...
        <div class="container" style="font-family: 'OpenSans';">
            ...
            <div class="clearfix row">
                    ...
                    <div class="row form-item-ck">
                        ...
                        <div class="col-xs-12 col-md-6">
                            <input type="text" maxlength="100" name="billing_fname" id="billing_fname"
                                ...
                                value="{{ $billingAddress->billing_fname ?? '' }}" wire:model="billing_fname">
                            @error('billing_fname')
                ...
                <div class="col-sm-4">
                    ...
                    {{-- <div class="icons-number">3</div>
                        <div style="margin-top: -20px; padding-left: 35px;">Payment Method</div>
                        <br>
                        <div class="payment_options" onclick="changepayment('paypal')">
                            <input type="radio" id="paypal" name="payment" required checked value="paypal" class="filled">
                            <label for="paypal"><img src="images/payment2.png"></label>
                            <div class="check"><div class="inside"></div></div>
                        </div>
                        <div class="payment_options" onclick="changepayment('alipay')">
                            <input type="radio" id="aliexpress" name="payment" required value="alipay" class="filled">
                            <label for="aliexpress"><img src="images/alipay.png"></label>
                            <div class="check"><div class="inside"></div></div>
                            <div style="border-bottom: 1px solid #000;width:100%;height:10px;"></div>
                        </div> --}}
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="right" style="padding: 8px; text-align: right; border-bottom: 1px solid #000; font-size:13px;">
                                        <input class="noborder paypal-payment filled" disabled type="text" style="text-align: right; display: block;" id="subtotal_text" name="subtotal_text" value="">
                                        <input class="noborder filled" type="hidden" style="text-align:right;" id="subtotal" name="subtotal" value="">
                                ...
                                <tr>
                                    ...
                                    <td align="right" style="padding: 8px; text-align: right; border-bottom: 1px solid #000; font-size:13px;">
                                        <input class="noborder paypal-payment filled" disabled style="text-align: right; font-weight: bold; display: block;" type="text" id="nettotal_text" name="nettotal_text" value="">
                                        <input class="noborder filled" style="text-align:right; font-weight:bold;" type="hidden" id="nettotal" name="nettotal" value="">
                                    </td>
                                </tr>
                                <tr>
