...
<body
    style="font-family: Arial, sans-serif; color: #333; background-color: #f9f9f9; margin: 0; padding: 20px; line-height: 1.6;">
    <div
        ...
        <p style="font-size: 16px;">Dear <strong>{{ $order->customer->first_name }}
        ...
        <p style="font-size: 16px;"><strong>New Status:</strong> <span style="color: #ff5722;">{{ $newStatus }}</span>
        </p>

        <h3 style="color: #333; border-bottom: 2px solid #4CAF50; padding-bottom: 5px;">Order Details:</h3>
        <ul style="list-style: none; padding: 0; font-size: 16px;">
            <li style="margin-bottom: 8px;"><strong>Order Date:</strong>
                {{ date('M d, Y', strtotime($order->order_date)) }}</li>
