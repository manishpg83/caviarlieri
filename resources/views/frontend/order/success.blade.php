...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-lg mx-auto bg-white rounded-lg shadow-md p-6">
        <div class="text-center">
            ...
            <p class="text-gray-600 mb-4">
                If you have any questions or need assistance, feel free to contact us at <a href="mailto:marketing@swisscaviarlieri.com" class="text-blue-600 underline">marketing@swisscaviarlieri.com</a>.
            </p>
            <p class="text-gray-600 mb-4">
