                            ...
                            <div class="item mob-banner1"
                                ...
                                <div class="home-banner-container">
                                    <div class="banner1-txt">
                                        ...
                                        <p class="text-uppercase mb-3 mt-1 GothamLight">Swiss Caviar Cellular Therapy
                                            Supplement</p>
                                        <a href="outstanding-benefits.php" class="gold-btn"><span
                                                class="btn-content-wrapper"><span
                                                    class="btn-content-text">Discover</span></span></a>
                        ...
                        <div class="home-banner-container">
                            <div class="banner1-txt">
                                ...
                                <div class="p-2" align="center"><img
                                        src="https://cdn2-bread6hkcwg3dyar.z01.azurefd.net/assets/images/Vector.png"
                                        style="width: 25px;" alt=""></div>
                                <p class="text-uppercase mb-3 mt-1 GothamLight">Swiss Caviar Cellular Therapy Supplement
                                </p>
                                <a href="outstanding-benefits.php" class="gold-btn"><span
                                        class="btn-content-wrapper"><span
                                            class="btn-content-text">Discover</span></span></a>
        ...
        <div class="col-lg-9 col-md-11 m-auto float-none">
            ...
            <div class="section">
                <div class="row m-0 seven-cols px-5 px-md-0" align="center">
                    <div class="col-md-1 px-3"><img src="{{ asset('frontend/images/home/logo1.png') }}" width="100%"
                            alt="" /></div>
                    <div class="col-md-1 px-3"><img src="{{ asset('frontend/images/home/logo2.png') }}" width="100%"
                            alt="" /></div>
                    <div class="col-md-1 px-3"><img src="{{ asset('frontend/images/home/logo3.png') }}" width="100%"
                            alt="" /></div>
                    <div class="col-md-1 px-3"><img src="{{ asset('frontend/images/home/logo4.png') }}" width="100%"
                            alt="" /></div>
                    <div class="col-md-1 px-3"><img src="{{ asset('frontend/images/home/logo5.png') }}" width="100%"
                            alt="" /></div>
                    <div class="col-md-1 px-3"><img src="{{ asset('frontend/images/home/logo6.png') }}" width="100%"
                            alt="" /></div>
                    <div class="col-md-1 px-3"><img src="{{ asset('frontend/images/home/logo7.png') }}" width="100%"
                            alt="" /></div>
                </div>
            </div>
