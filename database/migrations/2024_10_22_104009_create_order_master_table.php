...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('order_master', function (Blueprint $table) {
            ...
            $table->enum('order_status', ['Pending', 'Paid', 'Cancelled', 'Sales Transfered to US'])->default('Pending');            $table->enum('order_type', ['Regular','Zero Value','Partial','Online','Offline'])->default('Regular');
